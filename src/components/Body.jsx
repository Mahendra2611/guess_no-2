...
const Body = () => {
  ...
  return (
    <div className='w-[100%] h-screen ' style={{backgroundImage:`url(${IMG3})`,backgroundSize: 'cover', backgroundPosition: 'center',backgroundRepeat:"no-repeat"}}>
      <GuessNumber/>
      <div>
      <div className='float-right  my-[35%] sm:my-[2%] mx-[2%] sm:mx-[7%]  py-2 px-2 rounded-lg font-semibold text-sm sm:text-3xl bg-gradient-to-r from-pink-500 to-yellow-500 '>
        Score - {score}
      </div>
